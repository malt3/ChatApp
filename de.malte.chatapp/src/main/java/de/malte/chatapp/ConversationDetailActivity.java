...
private PersonDataSource personDataSource = new PersonDataSource(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            setTitle(getIntent().getStringExtra(ConversationDetailFragment.ARG_PERSON_NAME));
            arguments.putLong(ConversationDetailFragment.ARG_PERSON_ID,
                    getIntent().getLongExtra(ConversationDetailFragment.ARG_PERSON_ID, 0));
