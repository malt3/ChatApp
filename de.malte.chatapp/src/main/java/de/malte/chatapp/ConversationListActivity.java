...
import de.malte.chatapp.newConversation.NewConversationActivity;
...
public class ConversationListActivity extends FragmentActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.actions_conversation_list, menu);
    ...
    public void onItemSelected(Person person) {
        if (mTwoPane) {
            ...
            arguments.putLong(ConversationDetailFragment.ARG_PERSON_ID, person.getId());
            ...
            detailIntent.putExtra(ConversationDetailFragment.ARG_PERSON_ID, person.getId());
            detailIntent.putExtra(ConversationDetailFragment.ARG_PERSON_NAME, person.getNickname());
